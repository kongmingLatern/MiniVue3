...
function createRenderer(options) {
    ...
    // 处理 Flagment 类型
    function processFlagment(vnode, container, parentComponent) {
...
export { createApp, createRenderer, createTextVNode, createVNode, getCurrentInstance, h, inject, provide, renderSlots };
